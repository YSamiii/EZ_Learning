...
const output='F:/ChatGPT app/手机端/学习游戏/验收候选/v0.4.0-rc2/qa';
...
const report={version:'v0.4.0-rc2',checks:{},courses:{},viewports:{},errors:[]};
...
async function ready(page,version='0.4.0-rc2'){await page.waitForFunction(expected=>window.__XIXI_APP_VERSION__===expected&&window.__XIXI_APP_READY__===true,version,{timeout:15000})}
...
async function testCourses(page){
  ...
  report.checks.courseSteps=true;report.checks.lessonViewports360_375_390=true;report.checks.correctIncorrectRetry=true;report.checks.traceDrawing=true;report.checks.progressPersistenceDoubleTap=true;
